...
<Article title={$_("home.works.title")} link={resolve('/(app)/works')} linkText={$_("home.works.callToAction")}>
    <p style="text-align: justify;">
        ...
        "home.works.content.2",
    )}
        <ArticleLink title="Beacharound S.r.l." href={`${import.meta.env.VITE_APP_BEACHAROUND_URL}`}/>{$_(
        "home.works.content.3",
    )}
        <ArticleLink title="Mango Mobile S.r.l." href={`${import.meta.env.VITE_APP_MANGO_URL}`}/>{$_(
        "home.works.content.4",
    )}
...
<Article title={$_("home.bio.title")} link={resolve('/(app)/about')} linkText={$_("home.bio.callToAction")}>
    <div class="timeline-container">
        ...
        <div class="row">
            ...
            <span class="line-separator"></span>
            <p>
                {$_("home.bio.content.11")}
                <ArticleLink
                        title="Quadra S.r.l."
                        href={`${import.meta.env.VITE_APP_QUADRA_URL}`}
                />{$_("home.bio.content.12")}
            </p>
        </div>
    </div>
</Article>
...
<style lang="scss">
  ...
  .timeline-container {
    ...
    &::after {
      ...
      width: 5px;
      height: 30px;
      background: linear-gradient(to bottom, rgba(0, 0, 0, 0), var(--backgroundColor));
    }
  }
